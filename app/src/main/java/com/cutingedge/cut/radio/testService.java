...
public class testService extends Service implements OnCompletionListener,
    ...
    private static final String URL_STRING = "http://radio.cut.ac.cy:8000/";
...
//                menu1_Fragment.BROADCAST_SEEKBAR));
